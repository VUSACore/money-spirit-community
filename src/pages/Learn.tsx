...
const Learn = () => {
  ...
  return (
    <div className="p-6 md:p-8 ss-appear">
      ...
      <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '36px', fontWeight: 300, color: '#FFFFFF', letterSpacing: '-0.03em', marginBottom: '4px' }}>Learn</h1>
      <p style={{ fontFamily: 'var(--font-body)', fontSize: '14px', color: '#D8C896', marginBottom: '24px' }}>Courses and resources to deepen your financial wellbeing.</p>
