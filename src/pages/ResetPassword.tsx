      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '14px', color: '#D8C896' }}>Set your new password</p>
          </div>
          ...
          {!ready ? (
            <div style={{
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <p style={{ color: '#D8C896', fontSize: '14px', fontFamily: 'var(--font-body)' }}>Verifying your reset link…</p>
              </div>
            </div>
          ) : (
            <div style={{
